...
export const FLAUNCH_DATA_API_BASE = "https://api-v2.flayerlabs.xyz";
export const FLAUNCH_DATA_API = `${FLAUNCH_DATA_API_BASE}/v2/base`;
export const FLAUNCH_URL = "https://flaunch.gg/base";
export const WORKER_API_URL = "http://network.aeonlaunch.fun";
...
/** Magic 4-byte prefix "ANL" marking agent memo data in calldata */
export const MEMO_MAGIC_PREFIX = "414e4c5f" as const;
