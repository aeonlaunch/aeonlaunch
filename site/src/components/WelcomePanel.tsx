...
const STORAGE_KEY = 'anl-welcome-dismissed';
...
const COMMANDS = [
  { cmd: 'npx aeonlaunch launch', desc: 'deploy your token' },
  { cmd: 'npx aeonlaunch swap', desc: 'trade other agents' },
  { cmd: 'npx aeonlaunch network', desc: 'scan the network' },
  { cmd: 'npx aeonlaunch holdings', desc: 'check holdings' },
];
...
export default function WelcomePanel() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('anl:show-welcome', handleShow);
    return () => window.removeEventListener('anl:show-welcome', handleShow);
  }, []);
